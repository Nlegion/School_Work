# Усовершенствуйте функцию для подбора имени маленьким зеленым человечкам из планетной системы
# α
# −
# ω
# −
...
# −
# 4
#  (Альфа-Омега-Фомальгаут-4). Правила те же, только символы не могут повторяться, даже не учитывая регистр.
# Напомним правила:
